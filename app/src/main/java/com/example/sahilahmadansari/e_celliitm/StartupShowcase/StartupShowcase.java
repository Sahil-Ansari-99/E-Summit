package com.example.sahilahmadansari.e_celliitm.StartupShowcase;
...
import com.example.sahilahmadansari.e_celliitm.Adapters.StartupAdapter;
...
public class StartupShowcase extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_startup_showcase);

        toolbar=(Toolbar)findViewById(R.id.startup_toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle("Our Partners");
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_nav_toggle);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        drawerLayout=(DrawerLayout)findViewById(R.id.startup_drawer_layout);

        recyclerView=(RecyclerView)findViewById(R.id.startup_recyclerView);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    itemList.add(new StartupModel(hashMap.get("url"), hashMap.get("name")));
                }

                adapter=new StartupAdapter(getApplicationContext(), itemList);
