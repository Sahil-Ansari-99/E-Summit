package com.example.sahilahmadansari.e_celliitm.Speakers;
...
public class SpeakersMain extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar=(Toolbar)findViewById(R.id.speakers_toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle("Speakers");
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_nav_toggle);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        drawerLayout=(DrawerLayout)findViewById(R.id.speakers_drawer_layout);

        recyclerView=(RecyclerView)findViewById(R.id.speakers_recyclerView);
        GridLayoutManager mGridLayoutManager = new GridLayoutManager(SpeakersMain.this, 2);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    itemList.add(new SpeakersModel(hashMap.get("name"), hashMap.get("url"), hashMap.get("designation"), hashMap.get("linkedin")));
                }

                adapter=new SpeakersAdapter(getApplicationContext(), itemList);
        ...
        final NavigationView navigationView=(NavigationView)findViewById(R.id.speakers_nav_view);
